...
internal class EquityBL
{
    #region Internals
    internal BaseApiResponseDto GetDataFromYahooFinance(string strStockSympol, string strModule)
    {
    ...
    internal BaseApiResponseDto GetSmartSearchStocks(SmartSearchRequestDto dtoSmartSearchRequest)
    {
        BaseApiResponseDto response = new();
